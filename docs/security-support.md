...
- **The latest minor** (e.g. 1.5.x) always gets security patches.
- **The previous minor** (e.g. 1.4.x) gets security patches for **6
...
| Version | Status |
|---------|--------|
| 1.5.x | Supported (latest minor) |
| 1.4.x | Supported until 6 months after 1.5.0 |
| ≤ 1.3.x | End-of-life |
